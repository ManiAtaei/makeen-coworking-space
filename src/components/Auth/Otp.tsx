...
export default function Otp({setStep}) {
  ...
  return (
    <div className="pl-7 pr-5 w-full max-w-[600px] mx-auto flex flex-col justify-center ">
      <div className="flex flex-col items-center mt-[-15px]">
        ...
        <div className="w-full max-w-[408px]">
          ...
          >
            ...
            <button onClick={()=>setStep(5)} className="bg-[#253359] text-white text-[16px] font-xmedium py-2 px-[119.5px] w-full rounded-[8px] mt-5">
              ادامه
            </button>
          </form>
        </div>
